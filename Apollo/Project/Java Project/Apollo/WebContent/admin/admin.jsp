...
<html>
    ...
    <body>
                ...
                <div id="wrap2">
                    ...
                    <div id="leftside">
                        ...
                        <p class="menublock">
                            ...
                            <a class="nav" href="address.jsp">Hospital Details</a><br class="hide" />
		...
		%>             
                        <p><img src="img/gravatar-leaf.jpg" height="80" width="80"/></p>
...
<a href="#">Announcement6</a><br />
                    ...
                    <div id="content">
                        ...
                        <h3>Users</h3>
                        <p><a href="admin/admin.jsp">Log-in</a> :</p> <p><script type="text/javascript">document.write(Date())</script></p>
                        <p><a href="user_detail.jsp">User Detail</a></p>
