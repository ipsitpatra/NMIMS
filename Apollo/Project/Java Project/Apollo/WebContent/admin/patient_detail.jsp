...
<p class="menublock"><a class="nav" href="new_patient.jsp">New Patient</a><br class="hide" />
...
<table cellspacing="19" width="100%" border="0">
	...
	<tr>
		...
		<td>
		<div align="left"><strong>Check-In</strong></div>
		</td>
		<td>
	...
	<tr>
		...
		<td align="left" valign="top"><select name='Action'>
			...
			<option onClick="parent.location='patient_edit.jsp?id=<%=id %>'">Update</option>
			<option onClick="parent.location='patient_discharge.jsp?id=<%=id %>'">Discharge</option>
