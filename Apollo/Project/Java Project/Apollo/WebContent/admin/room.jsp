    ...
    <div id="container">
        ...
        <div id="wrap1">
            <div id="wrap2">
                ...
                <div id="topbox">
                    <strong><span class="hide">Currently viewing: </span><a href="admin.jsp">Patient Billing System</a> &raquo; <a href="room_detail.jsp">Room Details</a> &raquo; <a href="room.jsp">Room Information</a></strong>
                </div>
