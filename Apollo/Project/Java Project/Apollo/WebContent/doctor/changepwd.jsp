...
<html>
    ...
    <body>
        <div id="container">
            ...
            <div id="nav">
                <ul>
                    <li id="current"><a href="doctor.jsp">Front page</a></li>
            ...
            <div id="wrap1">
                <div id="wrap2">
                    ...
                    <div id="topbox">
                        <strong><span class="hide">Currently viewing: </span><a href="doctor.jsp">Patient Billing System</a> &raquo; <a href="doctor.jsp">Front page</a> &raquo; <a href="changepwd.jsp">Change password</a></strong>
                    </div>
