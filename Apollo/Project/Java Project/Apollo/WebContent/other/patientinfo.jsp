    ...
    <div id="container">
        ...
        <div id="wrap1">
            <div id="wrap2">
                ...
                <div id="topbox">
                    <strong><span class="hide">Currently viewing: </span><a href="admin.jsp">Patient Billing System</a> &raquo; <a href="patient_detail.jsp">Patient Details</a>&raquo; <a href="patientinfo.jsp">Patient Information</a></strong>
                </div>
                            ...
                            <td><form id="form1" name="form1" method="post" action="patient_detail.jsp" >
                                    <table width="100%" border="0" cellspacing="4" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="55%">: <%=patient.balance(a)%> <%=ardate%></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="45%">Delete Patient Details</td>
                                           <td width="55%"><a href="deletepatient.jsp?id=<%=a%>">>></a></td>
                                       </tr>
